    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="#"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-red-700 hover:text-white">Team</a>
                                <a href="#"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Welcome, {{ $patient->fname }} {{ $patient->lname }}</h1>
                ...
                <form action="{{ route('update')}}" method="POST">
                    ...
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            <h2 class="text-base/7 font-semibold text-gray-900">Attention</h2>
                            <p class="mt-1 text-sm/6 text-gray-600">Do not share login details with third party applications.</p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-3">
                                    <label for="first-name" class="block text-sm/6 font-medium text-gray-900">First
                                        name</label>
                                    <div class="mt-2">
                                        <input type="text" name="fname" id="fname" autocomplete="given-name" value="{{ $patient->fname }}"
                                    ...
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('fname'){{$message}} @enderror</label>
                                ...
                                <div class="sm:col-span-3">
                                    <label for="last-name" class="block text-sm/6 font-medium text-gray-900">Last
                                        name</label>
                                    <div class="mt-2">
                                        <input type="text" name="lname" id="lname" autocomplete="family-name"  value="{{ $patient->lname }}"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 sm:text-sm/6">
                                    </div>
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('lname'){{$message}} @enderror</label>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="email" id="fname" autocomplete="given-name" value="{{ $patient->email }}" 
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 sm:text-sm/6">
                                    </div>
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('email'){{$message}} @enderror</label>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2 grid grid-cols-1">
                                        <select id="country" name="country" autocomplete="country-name"
                                            class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 sm:text-sm/6">
                                            <option class=" " >Sri Lanka</option>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('address'){{$message}} @enderror</label>

                                </div>

                                <div class="sm:col-span-2 sm:col-start-1">
                                    <label for="street-address" class="block text-sm/6 font-medium text-gray-900">Age</label>
                                    ...
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('age'){{$message}} @enderror</label>

                                </div>

                                <div class="sm:col-span-2">
                                    <label for="region" class="block text-sm/6 font-medium text-gray-900">Patient ID</label>
                                    <div class="mt-2">
                                        <input type="text" name="region" id="region" autocomplete="address-level1"   value="{{ $patient->id }}"  
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 sm:text-sm/6">
                                    </div>
                                </div>

                                <div class="sm:col-span-2">
                                    <label for="postal-code" class="block text-sm/6 font-medium text-gray-900">Emergency Contact</label>
                                    <div class="mt-2">
                                        <input type="text" name="emgcontact" id="emgcontact"   value="{{ $patient->Num }}"
                                            autocomplete="postal-code"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-red-600 sm:text-sm/6">
                                    </div>
                                    <label for="" class="block  font-medium text-red-600 hover:text-red-500 Cus-war-txt">@error('emgcontact'){{$message}} @enderror</label>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">We'll always let you know about important changes,
                                    ...
                                    <div class="mt-6 space-y-6">
                                        ...
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <label for="push-email"
                                                class="block text-sm/6 font-medium text-gray-900">Same as email</label>
                                        </div>
                                        <div class="flex items-center gap-x-3">
                                            <input id="push-nothing" name="push-notifications" type="radio"
                                                class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white checked:border-red-600 checked:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden [&:not(:checked)]:before:hidden">
                                            <label for="push-nothing"
                                                class="block text-sm/6 font-medium text-gray-900">No push
                                                notifications</label>
                                        </div>
                                    </div>
                                </fieldset>
...
@else
    ...
    <p>No patient data found in the session. Redirecting to login...</p>
@endif
